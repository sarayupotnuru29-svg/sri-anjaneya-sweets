...
//       {/* Why Choose Us - UPDATED TO SINGLE LINE ON DESKTOP */}
//       <section className="py-16 lg:py-20 bg-secondary">
//         <div className="container mx-auto px-4">
//           <h2 className="text-3xl lg:text-4xl font-display font-bold text-foreground text-center mb-10">
//             Why Choose <span className="text-primary">Us</span>
//           </h2>
//           {/* Using flex-nowrap or specific lg:grid-cols-3 to force one line */}
//           <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
//             {[
//               { icon: Shield, title: "Pure Ingredients", desc: "We use only pure ghee, fresh milk, and premium quality ingredients." },
//               { icon: Heart, title: "Made with Love", desc: "Handcrafted with care following time-honored traditional recipes." },
//               { icon: Award, title: "Trusted Quality", desc: "Serving Tallarevu for years with hygiene, freshness, and authentic taste." },
//             ].map(({ icon: Icon, title, desc }) => (
//               <div key={title} className="bg-card rounded-lg p-6 shadow-warm text-center space-y-3 flex flex-col items-center">
    ...
    <>
      ...
      <section className="py-16 lg:py-20 bg-secondary">
        <div className="container mx-auto px-4">
          ...
          {/* grid-cols-1 for mobile, md:grid-cols-3 for desktop row */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { icon: Shield, title: "Pure Ingredients", desc: "We use only pure ghee, fresh milk, and premium quality ingredients." },
              { icon: Heart, title: "Made with Love", desc: "Handcrafted with care following time-honored traditional recipes." },
      ...
      <section className="py-14 lg:py-16 bg-gradient-warm">
        <div className="container mx-auto text-center space-y-4">
          {/* UPDATED: text-black for the heading */}
          <h2 className="text-2xl lg:text-3xl font-display font-bold text-black">
            Craving Traditional Sweets?
          </h2>
          <p className="text-primary-foreground/80 font-body max-w-md mx-auto">
            Place your order instantly via WhatsApp. Fresh sweets delivered with love!
